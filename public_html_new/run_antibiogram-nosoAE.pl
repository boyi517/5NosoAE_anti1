...
##### Query alletic profile #####
system("2.Query-Profiling.pl -i ./temp/$folder/contigFile.fa -d /home/chieh/antibiogram_platform/databases/cgMLST_db -b $organism -o ./temp/$folder/2.QueryProfile -p 12");

open(OUT, ">temp/$folder/queryProfile_ok");
close(OUT);
################################


##### Antibiogram generation and comparison #####
system("3.Antibiogram-Comparison-alleticDist.pl -i ./temp/$folder/contigFile.fa -j ./temp/$folder/2.QueryProfile/alleleMatrix.1 -b $organism -o ./temp/$folder/3.abProfilesCmp -p 12");
...
##### cgMLST profiling #####
system("4.cgMLST-Profiler-alleticDist.pl -i ./temp/$folder/2.QueryProfile -d /home/chieh/antibiogram_platform/databases/cgMLST_db -h ./temp/$folder/3.abProfilesCmp/hits_table.tsv -b $organism -o ./temp/$folder/4.cgProfiles -p 12");
