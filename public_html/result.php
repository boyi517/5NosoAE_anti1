...
if (!preg_match_all($pattern, $folder)) {
	exit();
}
...
//other菌 => 不要tree
if(!(file_exists("./temp/$folder/5.DendroPlot"))) {  
$no_tree="notree";
}
?>
...
$(document).ready(function() {
    ...
    if (filesize < 55) { //有無抗藥基因

        $(".nav-tabs").addClass("lidisplay");
        $(".tab-content").addClass("lidisplay");
        swal("Result", "No resistance genes were detected", "warning", {
            button: "OK",
        });
        var html =
            '<div class="row">' +
            ...
            '</div>' +
            '<div class="col-md-12">' +
            '<h3 style="font-weight: bolder; color:blue;"><i class="bi bi-exclamation-triangle-fill"></i> No resistance genes were detected</h3>' +
            '</div>' +
    ...
    var notree = "<?php echo $no_tree;?>";

    if (notree == "notree") { //  不要畫tree   
        $("#li_wg").addClass("lidisplay");
    }
...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-10">
            <h5><a href="./temp/<?php echo $folder ?>/contigFile.fa"
                    download="<?php echo $contigFile[0]; ?>"><?php echo $contigFile[0]; ?></a></h5>
        </div>
    </div>
    <div class="row">
        <div class="col-md-2">
    ...
    <div class="tab-content" id="myTabContent">
        ...
        <div class="tab-pane fade show active row" id="divQuery" role="tabpanel">
            <div class="row">
                <h4 class="col-md-11" style="font-weight: bolder">
                    <i class="bi bi-folder-check"></i></i> Resistance genes & Antibiotics
                </h4>
            </div>
            <iframe src="https://nosoae.imst.nsysu.edu.tw/query_table.php?folder=<?php echo $folder; ?>"
                class="justify-content-center" height="850px" width="1200px" allowfullscreen>
            </iframe>
        </div>
        <!--Query內容-->
        <!--Table內容-->
        <div class="tab-pane fade show row" id="divTable" role="tabpanel">
            <div class="row">
                <h4 class="col-md-12" style="font-weight: bolder">
                    <i class="bi bi-list-ul"></i> Antimicrobial resistance profile search
                </h4>
            </div>
            ...
            <div class="row d-flex justify-content-center">
                ...
                <br/><br/>
                <h6 class="col-md-12">
                    <i class="bi bi-lightbulb-fill"></i>　The lower the p-value, the greater the statistical
                    significance
        ...
        <div class="tab-pane fade row" id="divHeatMap" role="tabpanel">
            <div class="row">
                <h4 class="col-md-12" style="font-weight: bolder">
                    <i class="bi bi-grid-3x3"></i> Heatmap of antimicrobial resistance profiles
                </h4>
            </div>
        ...
        <div class="tab-pane fade row" id="divTree" role="tabpanel">
            <div class="row">
                <h4 class="col-md-5 justify-conteny-start" style="font-weight: bolder">
                    <i class="bi bi-diagram-3-fill"></i> cgMLST analysis
                </h4>
                <div class="col-md-1">
                    <!--Tree&下載(同一行)中間空格-->
                </div>
                <h4 class="col-md-5 justify-conteny-end hide-download-1" style="font-weight: bolder">
                    <i class="bi bi-file-earmark-arrow-down-fill"></i> Downloads
                </h4>
            </div>
                    ...
                    <div class="col-md-5 hide-download-1">
                        ...
                        <table class="table table-responsive">
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <li style="font-size:17px"><B>Ete3 dendrogram：</B></li>
                                    </td>
                                    <td><a href="./temp/<?php echo $folder; ?>/5.DendroPlot/NJtree_cgMLST.newick"
                                            target="_blank" style="text-decoration:none;color:#3498DB;"
                                            download="NJtree_cgMLST.newick">NJtree_cgMLST.newick</a>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td><a href="./temp/<?php echo $folder; ?>/5.DendroPlot/NJtree_cgMLST.pdf"
                                            target="_blank" style="text-decoration:none;color:#3498DB;"
                                            download="NJtree_cgMLST.pdf">NJtree_cgMLST.pdf</a>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <li style="font-size:17px"><B>SciPy dendrogram：</B></li>
                                    </td>
                                    <td><a href="./temp/<?php echo $folder; ?>/5.DendroPlot/dendrogram_cgMLST.pdf"
                                            target="_blank" style="text-decoration:none;color:#3498DB;"
                                            download="dendrogram_cgMLST.pdf">dendrogram_cgMLST.pdf</a>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
